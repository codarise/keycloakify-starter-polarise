        ...
        >
            ...
            <div className={kcClsx("kcFormGroupClass")} no-bottom-margin="true" style={{ marginBottom: 0 }}>
                {authenticators !== undefined && Object.keys(authenticators).length !== 0 && (
                    <>
                        <form id="authn_select" className="flex flex-col gap-4">
                        ...
                        {shouldDisplayAuthenticators && (
                            <>
                                {authenticators.authenticators.length > 1 && (
                                    <p className="text-sm pb-4">{msg("passkey-available-authenticators")}</p>
                                )}
                                        ...
                                        <div key={i} id={`kc-webauthn-authenticator-item-${i}`} className="flex flex-col gap-2 bg-card/50 border border-border/50 px-4 py-2 rounded-md">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="flex flex-col gap-2 bg-card p-2 rounded-md">
                                                    <span className="text-sm text-muted-foreground" id={`kc-webauthn-authenticator-createdlabel-${i}`}>{msg("passkey-createdAt-label")}</span>
