    ...
    return (
        ...
        >
            <div id="kc-oauth" className="content-area">
                <h3 className="text-sm pb-2">{msg("oauthGrantRequest")}</h3>
                <ul className="flex flex-col gap-2">
                    {oauth.clientScopesRequested.map(clientScope => (
                        <li key={clientScope.consentScreenText}>
                            <span className="text-sm bg-card/50 border border-border/50 rounded-lg p-2">
                        ...
                        <h3>
                            ...
                            {client.attributes.tosUri && (
                                <>
                                    ...
                                    <a className={buttonVariants({ variant: "outline", size: "sm" })} href={client.attributes.tosUri} target="_blank">
                                        {msg("oauthGrantTos")}
                                    </a>
                                </>
                            )}
                            {client.attributes.policyUri && (
                                <>
                                    {msg("oauthGrantReview")}
                                    <a className={buttonVariants({ variant: "outline", size: "sm" })} href={client.attributes.policyUri} target="_blank">
