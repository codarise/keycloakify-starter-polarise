    ...
    return (
        <div className="mx-auto h-screen flex flex-col justify-between items-center p-0 md:p-4 relative">
            ...
            <div className="flex flex-col items-center justify-between w-full">
                ...
                <span className="text-xs text-muted-foreground text-center mt-4">By clicking continue, you agree to our <br/><a href="https://polarise.eu/terms-and-conditions" className="underline">Terms of Service</a> and <a href="https://polarise.eu/privacy-policy" className="underline">Privacy Policy</a>.</span>
            </div>
